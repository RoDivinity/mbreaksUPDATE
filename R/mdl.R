...
#' \itemize{
#' \item{`dotest()` conducts Sup F tests of `0` versus `m` breaks and Double Max tests}
#' \item{`doseqtests()` conducts the sequential Sup F tests of l versus l+1 breaks}
#' \item{`doorder()` conducts the number of breaks selection from `1` to `m`
#'  breaks using information critera: `{'KT','BIC','LWZ'}`}
#' \item{`dosequa()` conducts the number of breaks selection by sequential tests
#'  from `1` to `m` breaks using sequential Sup F tests}
#' \item{`dofix()` conducts structural break model estimation with `fixn` breaks}
#' }
...
#'\itemize{
#'\item{sbtests: class `sbtests` of Sup F tests of 0 versus m breaks and Double Max tests}
#'\item{seqtests: class `seqtests` of sequential Sup F test of l versus l+1 breaks }
#'\item{BIC: class `model` of structural break model with estimated number of breaks by BIC criterion}
#'\item{LWZ: class `model` of structural break model with estimated number of breaks by LWZ criterion}
#'\item{KT: class `model` of structural break model with estimated number of breaks by KT criterion}
#'\item{sequa: class `model` of structural break model with estimated number of breaks by sequential tests}
#'\item{fix:  class `model` of structural break model with pre-specified `fixn` number of breaks}
#'}
#'
